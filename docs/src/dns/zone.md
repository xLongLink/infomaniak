...
- `description`: Include record-level descriptions in the response when set to `True`.
...
- `description`: Include descriptions for updated records when set to `True`.
- `idn`: Return internationalized domain data when set to `True`.
...
- `description`: Include descriptions for created records when set to `True`.
- `idn`: Return internationalized domain data when set to `True`.
